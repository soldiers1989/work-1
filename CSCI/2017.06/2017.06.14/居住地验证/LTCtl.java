...
public class LTCtl {
    ...
    @ResponseBody
    public String getGxminWork(HttpServletRequest request, String sendTelNo, String longitude, String latitude, String orgCode, String curTime, String orgSeq, String sequence, String merchantId) {
        String portrait_result = "";
        try {
            // 创建一个json格式的参数对象
     ...
     * @Description: 白名单查询
     * @author ly
     * @date 2017年6月2日 18:55:01
     * @param request
     * @return
     */
    @RequestMapping(value = "/UserWhite", produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String getUserWhite(HttpServletRequest request, String sendTelNo, String orgCode, String curTime, String orgSeq, String sequence, String merchantId) {
        String portrait_result = "";
        try {
            // 创建一个json格式的参数对象
            JSONObject paramData = new JSONObject();
