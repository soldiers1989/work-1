...
public class RollBackServiceImpl implements IRollBackService {
     ...
     * 添加合作机构信息
     */
    public int addMerchant(Map<String, String> params) throws Exception {
        try {
            BaseSupport.myBatisSessionTemplate.insert("orm.zz.tbMerchantTempMapper.addMerchant", params);
        } catch (Exception e) {
            logger.error("addMerchant-->" + e);
            throw new Exception(e.getMessage());
        }
        return 1;
    }
     ...
     * @return
     */
    public int addMerchant(Map<String, String> tbMerchant, Map<String, String> params) throws Exception {
        try {
            tbMerchant.put("CHECK_TIME", Util.getCurrentDateTimeString());
            tbMerchant.put("CHECK_TLRNO", BaseSupport.CframeUtil.GetCurrentUserName());
            if (tbMerchant.get("OP_FLAG").equals("增加")) {
                BaseSupport.myBatisSessionTemplate.insert("orm.zz.tbMerchantDetailMapper.addMerchant", tbMerchant);
            } else if (tbMerchant.get("OP_FLAG").equals("修改")) {
                BaseSupport.myBatisSessionTemplate.delete("orm.zz.tbMerchantDetailMapper.delMerchant", params);
                BaseSupport.myBatisSessionTemplate.insert("orm.zz.tbMerchantDetailMapper.addMerchant", tbMerchant);
            } else if (tbMerchant.get("OP_FLAG").equals("删除")) {
                BaseSupport.myBatisSessionTemplate.delete("orm.zz.tbMerchantDetailMapper.delMerchant", params);
            }
            BaseSupport.myBatisSessionTemplate.delete("orm.zz.tbMerchantTempMapper.delMerchanttempByMerchant_ID", params);
            BaseSupport.myBatisSessionTemplate.update("orm.zz.tbMerchantDetailMapper.updateMerchantCheck", tbMerchant);
        } catch (Exception e) {
            logger.error("addRole-->" + e);
            throw new Exception(e.getMessage());
        }
     ...
     * @return
     */
    public void delMerchant(Map<String, String> params) throws Exception {
         try {
            BaseSupport.myBatisSessionTemplate.delete("orm.zz.tbMerchantTempMapper.delMerchanttempByMerchant_ID", params);
        } catch (Exception e) {
