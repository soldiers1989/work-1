...
public class ExecutionServiceImpl implements ExecutionService {
    ...
    public void deleteExecutionS(Map<String, String> parmes) {
        myBatisSessionTemplate.insert("orm.mapper.zz.br.ExecutionMapper.deleteExecutionS", parmes);
    }

    @Override
    public void insertExecutionS(Map<String, String> parmes) {
        myBatisSessionTemplate.insert("orm.mapper.zz.br.ExecutionMapper.insertExecutionS", parmes);
    }
}
