@RequestMapping(value = "/Disruptinfo", produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String getDisruptinfo(HttpServletRequest request, String apiKey, String dataType, String queryName
        ...
        try {
            ...
            // 将json格式的对象转换成字符串 faith_Disruptinfo
            portrait_result = httpsUtil.postMsg(BCServiceUrl + "Disruptinfo", "paramData=" + paramData.toString());

            logger.info("getDisruptinfo_parmData 输出--->:" + paramData);
        } catch (Exception e) {
            logger.error("getDisruptinfo_ERROR 输出--->:" + e);
        }
