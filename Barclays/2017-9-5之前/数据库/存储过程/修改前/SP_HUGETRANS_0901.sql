USE [SOAR]
GO
/****** Object:  StoredProcedure [dbo].[SP_HUGETRANS_0901]    Script Date: 2017/9/4 18:06:42 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  --参数定义
  DECLARE @RULE_CODE     VARCHAR(15)  = '0901'    --规则代码   0901
...
BEGIN TRY   
  ...
  DECLARE CURSOR_0901 CURSOR FOR
  ...
  FETCH NEXT FROM CURSOR_0901 INTO @CLIENT_ID
