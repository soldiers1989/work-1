USE [SOAR]
GO
/****** Object:  StoredProcedure [dbo].[SP_HUGETRANS_0904]    Script Date: 2017/9/4 18:08:32 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  --参数定义
  DECLARE @RULE_CODE     VARCHAR(15)  = '0904'    --规则代码   0904
...
BEGIN TRY  
  ...
  DECLARE CURSOR_0904 CURSOR FOR
  ...
  FETCH NEXT FROM CURSOR_0904 INTO @CLIENT_ID
